...
export const heritageFraming = {
  headline: 'Trust over fancy',
  body: 'Customers pay a premium for zip-lock atta and house pickles because they trust the contents — not the packaging. Hyperlocal loyalists within 1 km value conduct over art direction.',
  audience: 'Gujarati-Kachchi women, 40–65, Ghatkopar and Tilak Nagar belt.',
}
